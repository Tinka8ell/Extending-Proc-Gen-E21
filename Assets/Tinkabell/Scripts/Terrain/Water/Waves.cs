...
public class Waves : MonoBehaviour
{
    ...
    {
        //Mesh Setup
        GameObject mapGenerator = GameObject.FindGameObjectWithTag("TerrainGenerator");
        TerrainGenerator terrainGenerator = mapGenerator.GetComponent<TerrainGenerator>();
        MeshSettings meshSettings = terrainGenerator.meshSettings;
        Dimension = meshSettings.numVertsPerLine;
        Mesh = new Mesh();
